...
public static class CommandBinderGenerator
{
    // --- CORRECTED: Use fully qualified names ---
    // (I'm assuming CommandAttribute is in the same namespace)
    private const string CommandAttributeName = "Cli.Toolkit.SourceGenerators.Attributes.CommandAttribute";
    private const string OptionAttributeName = "Cli.Toolkit.SourceGenerators.Attributes.OptionAttribute";
    private const string ArgumentAttributeName = "Cli.Toolkit.SourceGenerators.Attributes.ArgumentAttribute";
    ...
    private static void GenerateBinder(SourceProductionContext spc, CommandToGenerate command)
    {
        ...
        builder.AppendLine($"namespace {Constance.NamespaceBase}.CommandBinders;"); 
        builder.AppendLine();
        ...
        builder.AppendLine($"{CommandBinderCode.TryGetNextCode}");
